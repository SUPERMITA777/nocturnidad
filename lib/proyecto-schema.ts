...
// Texto literal exacto con Usos Mixtos y fomento cultural/formativo
export const DEFAULT_PROYECTO_LEY: ProyectoLey = {
  titulo: "RÉGIMEN INTEGRAL DE FUNCIONAMIENTO, CONVIVENCIA, SEGURIDAD PREVENTIVA, CONTROL TERRITORIAL, ESPACIOS DE USOS MIXTOS Y FOMENTO DE LA ACTIVIDAD CULTURAL Y NOCTURNA DEL PARTIDO DE FLORENCIO VARELA",
  normasModificadas: [
  ...
  considerandos: [
    "Que el crecimiento demográfico, urbano, comercial y cultural del Partido de Florencio Varela exige una regulación moderna, integral y eficaz de las actividades de esparcimiento nocturno, gastronomía, expresiones artísticas y espectáculos públicos;",
    "Que la actividad desarrollada por bares, salones de eventos, locales bailables, centros culturales, clubes sociales y establecimientos gastronómicos con actividad nocturna y formativa constituye un motor fundamental de la economía local, generando empleo directo e indirecto para trabajadores gastronómicos, técnicos de sonido e iluminación, artistas, personal de logística y seguridad;",
    "Que los nuevos modelos de desarrollo cultural y gastronómico requieren trascender los esquemas rígidos de habilitación única, reconociendo la multifuncionalidad y los usos mixtos de los espacios (tales como talleres, clases de danzas o canto, degustaciones y maridajes, peñas tradicionales, milongas y muestras artísticas) que enriquecen la vida comunitaria y comercial sin alterar la esencia del rubro principal;",
    "Que la experiencia de aplicación de la Ordenanza N.º 10.329/23 ha demostrado que los esquemas excesivamente restrictivos no suprimen la demanda recreativa de la población, sino que provocan el desplazamiento de los asistentes hacia eventos y fiestas clandestinas en quintas y galpones periféricos no habilitados;",
    ...
    "Que resulta imperativo conciliar el derecho al trabajo, al esparcimiento, a la formación artística y a la inversión local con el legítimo derecho de los vecinos linderos al descanso, la tranquilidad pública, la seguridad vial y el uso pacífico del espacio público;",
      ...
      articulos: [
        {
          numero: 1,
          titulo: "Objeto",
          contenido: "La presente Ordenanza tiene por objeto establecer un régimen integral para el funcionamiento, habilitación, seguridad preventiva, usos mixtos culturales, control en territorio y convivencia de los establecimientos que desarrollen actividades recreativas, formativas, gastronómicas y nocturnas en el Partido de Florencio Varela, compatibilizando:\na) El derecho al trabajo formal y al desarrollo de actividades comerciales, culturales, formativas y recreativas lícitas.\nb) La seguridad física e integral de trabajadores, concurrentes, frentistas y terceros.\nc) El derecho de los vecinos al descanso, la tranquilidad y el uso adecuado del espacio público.\nd) La prevención activa de hechos de violencia, siniestros y situaciones de riesgo antes, durante y después de cada actividad.\ne) El cumplimiento estricto y coordinado de las normativas municipales, provinciales y nacionales aplicables.\nf) La promoción prioritaria de la mano de obra, proveedores y artistas locales, mediante incentivos.",
        },
        {
          numero: 2,
          titulo: "Principios rectores",
          contenido: "La aplicación de la presente Ordenanza se regirá por los principios de:\na) Prevención previa y territorial.\nb) Razonabilidad y proporcionalidad sancionatoria.\nc) Gradualidad y subsanabilidad de faltas administrativas.\nd) Debido proceso y derecho de defensa.\ne) Responsabilidad objetiva del titular en el perímetro inmediato de funcionamiento.\nf) Objetividad técnica en las constataciones de infracciones.\ng) Convivencia armónica entre la actividad comercial, cultural y la comunidad vecinal.\nh) Legalidad y no discriminación.",
        },
      ],
    },
    {
      numero: "CAPÍTULO II",
      titulo: "ÁMBITO DE APLICACIÓN, USOS MIXTOS Y PERMISOS",
      articulos: [
        {
          numero: 3,
          titulo: "Establecimientos comprendidos y Usos Mixtos",
          contenido: "Quedan comprendidos en el presente régimen todos los establecimientos y predios habilitados para desarrollar actividades nocturnas en el Partido de Florencio Varela, tales como bares, restaurantes con actividad nocturna, cervecerías, locales bailables, salones de eventos y fiestas, centros culturales, clubes sociales y demás emprendimientos afines.\n\nReconócese la figura de \"Establecimientos de Usos Mixtos y Espacios Culturales/Gastronómicos\", facultando a los locales habilitados a desarrollar, en horarios diurnos o vespertinos y de forma compatible con su rubro principal, actividades formativas, de difusión y promoción comunitaria (tales como talleres, clases de baile, danza, canto o disciplinas escénicas, catas y degustaciones de productos locales o regionales, peñas, milongas, exposiciones y afines), sin requerir una nueva habilitación comercial autónoma.",
        },
        {
          numero: 4,
          titulo: "Permiso Especial de Actividad Cultural, Formativa y Recreativa Accesoria",
          contenido: "Los establecimientos comerciales o gastronómicos debidamente habilitados que deseen incorporar de forma habitual o periódica presentaciones artísticas, DJ, peñas, milongas, pistas complementarias de baile, clases o experiencias de degustación y maridaje, podrán solicitar el \"Permiso Especial y Precario de Actividad Cultural y Recreativa\".\nEl desarrollo de estas actividades integradas no será considerado como desvirtuación o alteración de rubro comercial a los efectos del régimen contravencional, siempre que se realicen dentro de los límites de capacidad asignados y se adecuen a las exigencias acústicas y de seguridad correspondientes a cada horario.",
        },
      ],
    },
    {
      ...
      articulos: [
        {
          ...
          contenido: "Los establecimientos alcanzados por la presente Ordenanza procurarán priorizar la contratación de personal operativo, logística, técnicos, seguridad, instructores formativos y presentaciones artísticas con residencia acreditada en el Partido de Florencio Varela.\nEl cumplimiento de esta priorización será considerado como antecedente positivo a los fines del Registro creado en el artículo siguiente, sin constituir obligación sancionable.",
        },
        {
          numero: 17,
      ...
      articulos: [
        {
          ...
          contenido: "Incorpórase como segundo párrafo del Inciso B del Artículo 37 de la Ordenanza N.º 442/77 el siguiente texto:\n\"No se configurará alteración ni desvirtuación de rubro pasible de clausura en aquellos establecimientos habilitados para gastronomía, salones, clubes o centros culturales que incorporen actividades formativas (clases y talleres), degustaciones, peñas, milongas o espectáculos artísticos y musicales accesorios, siempre que cuenten con el Permiso Especial correspondiente y no vulneren los límites sonoros objetivos ni el aforo fijado por la autoridad competente.\"",
        },
        {
          numero: 20,
